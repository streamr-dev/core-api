...
class ReflectionUtils {
	...
	static getConfigProperty(String name) {
		def value = grails.plugin.springsecurity.SpringSecurityUtils.securityConfig
	...
	static void setConfigProperty(String name, value) {
		def config = grails.plugin.springsecurity.SpringSecurityUtils.securityConfig
	...
	static boolean requestmapClassSupportsHttpMethod() {
		String httpMethodField = grails.plugin.springsecurity.SpringSecurityUtils.securityConfig.requestMap.httpMethodField
	...
	static Class getRequestMapClass() {
		String requestMapClassName = grails.plugin.springsecurity.SpringSecurityUtils.securityConfig.requestMap.className
