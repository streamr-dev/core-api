 ...
 */
class GormUserDetailsService implements grails.plugin.springsecurity.userdetails.GrailsUserDetailsService {
	...
	UserDetails loadUserByUsername(String username, boolean loadRoles) throws UsernameNotFoundException {
		...
		if (!user) {
			...
			throw new grails.plugin.springsecurity.userdetails.NoStackUsernameNotFoundException()
		}
	...
	protected UserDetails createUserDetails(user, Collection<GrantedAuthority> authorities) {
		...
		new grails.plugin.springsecurity.userdetails.GrailsUser(username, password, enabled, !accountExpired, !passwordExpired,
