...
public class KafkaFeed extends AbstractFeedProxy<UnifinaKafkaMessage, UnifinaKafkaMessage, StreamrMessage, String, MapMessageEventRecipient> {
	...
	@Override
	protected FeedEvent[] process(StreamrMessage msg) {
