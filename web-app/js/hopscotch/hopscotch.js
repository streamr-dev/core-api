...
if (buttons.showClose) {
	__p += '<a title="' 
		...
		'" href="#" class="hopscotch-bubble-close hopscotch-close pull-right">'+
		'<i class="fa fa-times"></i></a>';
}

__p += '<div class="hopscotch-bubble-container" style="width: '+
	((__t = ( step.width )) == null ? '' : __t) +
	'px;">';

	__p += '<div class="hopscotch-bubble-content">';
		if (step.content) {
			__p += '<div class="hopscotch-content">' +
				((__t = ( optEscape(step.content, tour.unsafe) )) == null ? '' : __t) +
				'</div>';
		}
	__p += '</div>'; // hopscotch-bubble-content
	...
	__p += '</div>'; // hopscotch-actions

__p += '</div>'; // bubble

__p += '<div class="hopscotch-bubble-arrow-container hopscotch-arrow">'+
