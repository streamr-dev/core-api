 ...
 */
    function StreamrSearch(el, modules, options, onSelected) {
        ...
        this.el.keydown(function(e) {
            if (e.keyCode == 13) {
                _this.streamrSearchMenu.find('.streamr-search-suggestion').eq(0)
                    .click()
            }
        })
    }
        ...
        return {
            ...
            templates: {
                ...
                suggestion: function(module) {
                    return '<div data-type=\'module\'><p class=\'streamr-search-suggestion-name\'>' + Streamr.escape(module.name) + '</p></div>'
                }
            },
            limit: Infinity
        }
            ...
            source: _.debounce(function(q, sync, async) {
                $.get(Streamr.createLink({
                    uri: 'api/v1/streams'
                        ...
                        public: true, search: q, uiChannel: false
                    }), function(result) {
