...
class UrlMappings {
	static mappings = {
		...
		"/api/v1/development/deploy/$name"(method: "GET", controller: "development", action: "deploy")
		"/api/v1/development/isMemberActive/$name"(method: "GET", controller: "development", action: "isMemberActive")
		"/api/v1/development/join/$name"(method: "GET", controller: "development", action: "join")
