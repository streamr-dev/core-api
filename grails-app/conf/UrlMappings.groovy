...
class UrlMappings {
	static mappings = {
		...
		"/api/v1/streams/$streamId/keys/$keyId"(method: "PUT", controller: "keyApi", excludes: ["create", "edit", "save", "index"], action: "update") { resourceClass = Stream }
		...
		"/api/v1/users/me/keys/$keyId"(method: "PUT", resources: "keyApi", excludes: ["create", "edit", "index", "save"], action: "update") { resourceClass = SecUser }
