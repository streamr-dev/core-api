 ...
 * Kafka config
 */
unifina.kafka.bootstrap.servers = System.getProperty("unifina.kafka.bootstrap.servers") ?: "192.168.10.21:9092"
unifina.kafka.zookeeper.connect = System.getProperty("unifina.kafka.zookeeper.connect") ?: "192.168.10.21:2181"
...
environments {
	production {
		unifina.kafka.bootstrap.servers = System.getProperty("unifina.kafka.bootstrap.servers") ?: "ip-10-16-207-139.ec2.internal:9092"
		unifina.kafka.zookeeper.connect = System.getProperty("unifina.kafka.zookeeper.connect") ?: "ip-10-16-207-139.ec2.internal:2181"
	}
}
