...
databaseChangeLog = {
	changeSet(author: "eric", id: "each-with-index-1") {
		insert(tableName: "module") {
			...
			column(name: "json_help", value: '{"params":{},"paramNames":[],"inputs":{"list":"an input list"},"inputNames":["list"],"outputs":{"indices":"a list of indices for the input list","list":"the original input list"},"outputNames":["indices","list"],"helpText":"<p>Generates a list from <strong>[0,n]</strong>&nbsp;according to the size <strong>n</strong>&nbsp;of the given input list.&nbsp;</p>"}')
		}
	}
}