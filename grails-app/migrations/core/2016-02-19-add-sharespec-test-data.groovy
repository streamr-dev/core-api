...
databaseChangeLog = {
	...
	changeSet(author: "jtakalai", context: "test", id: "2016021931337-1") {
		...
		insert(tableName: "canvas") {
			...
			column(name: "json", value: '{"settings":{"speed":"0","timeOfDayFilter":{"timeZoneOffset":120,"timeOfDayStart":"00:00:00","timeZoneDst":true,"timeOfDayEnd":"23:59:00","timeZone":"Europe/Helsinki"},"endDate":"2015-07-03","beginDate":"2015-07-02"},"name":"CanvasSpec test loading a SignalPath","uiChannel":{},"modules":[]}')//.replace('"', '\\"'))
		}
