...
<script id="streamr-label-template" type="text/template">
    <h1><streamr-label class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-label></h1>
</script>

<script id="streamr-heatmap-template" type="text/template">
    <streamr-heatmap class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-heatmap>
</script>

<script id="streamr-chart-template" type="text/template">
    <streamr-chart class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-chart>
</script>

<script id="streamr-table-template" type="text/template">
    <streamr-table class="streamr-widget non-draggable text-left" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-table>
</script>

<script id="streamr-button-template" type="text/template">
    <streamr-button class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-button>
</script>

<script id="streamr-switcher-template" type="text/template">
    <streamr-switcher class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-switcher>
</script>

<script id="streamr-text-field-template" type="text/template">
    <streamr-text-field class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-text-field>
</script>

<script id="streamr-map-template" type="text/template">
    <streamr-map class="streamr-widget non-draggable" canvas="{{ canvas }}" module="{{ module }}" dashboard="{{ dashboard }}"></streamr-map>
</script>
