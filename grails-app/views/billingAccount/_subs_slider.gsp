...
<div id="product-information" class="table-responsive">
		...
		<tr>
			<td>
				<span id="product-name">
					${ subscriptions?.subscription?.product?.name ? subscriptions.subscription.product.name : "Free" }
				</span>
			</td>
			<td>X amount of A</td>
			<td>Y amount of B</td>
			...
			<td>
				<span id="product-price">
					${ subscriptions?.subscription?.product?.price_in_cents ? subscriptions.subscription.product.price_in_cents / 100 : 0 }
				</span>
				€
			</td>
		</tr>
