					...
					<div class="panel-heading">
						...
						<div class="panel-heading-controls">
							...
							<form id="stream-delete-form">
								...
								<button data-action="${ createLink(action:'delete') }" data-confirm="Are you sure you want to delete the stream?" class="btn btn-primary btn-sm confirm">Delete stream</button>
							</form>
						</div>
					</div>
