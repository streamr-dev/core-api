...
class CanvasApiControllerSpec extends Specification {
	...
	void "index() renders authorized canvases as a list"() {
		...
		1 * controller.apiService.permissionService.get(Canvas, me, Permission.Operation.READ, false, _) >> [canvas1, canvas2, canvas3]
	}
	...
	void "index() adds name param to filter criteria"() {
		...
		then:
		1 * controller.apiService.permissionService.get(Canvas, me, Permission.Operation.READ, false, _) >> {Class resource, SecUser u, Operation op, boolean pub, Closure criteria ->
