...
public class StreamrBinaryMessageWithKafkaMetadataSpec extends Specification {
	...
	def "data is not altered on encode/decode"() {
		def msg = new StreamrBinaryMessageWithKafkaMetadata("testId", 0, System.currentTimeMillis(), 5, StreamrBinaryMessage.CONTENT_TYPE_STRING, "foo".getBytes("UTF-8"), 123, 122)
	...
	def "null previousOffset"() {
		def msg = new StreamrBinaryMessageWithKafkaMetadata("testId", 0, System.currentTimeMillis(), 5, StreamrBinaryMessage.CONTENT_TYPE_STRING, "foo".getBytes("UTF-8"), 123, null)
