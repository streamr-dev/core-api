...
class CanvasServiceSpec extends BeanMockingSpecification {
	...
	def "getCanvasURL() returns a link for the canvas"() {
		...
		then:
		1 * service.grailsLinkGenerator.link([controller: 'canvas', action: 'editor', id: myFirstCanvas.id, absolute: true]) >> "https://www.streamr.network/canvas/editor/1"
		link == "https://www.streamr.network/canvas/editor/1"
	}
